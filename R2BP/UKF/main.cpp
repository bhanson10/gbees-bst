...
vec RK87(double t0, double t1, vec y, double h, Traj lyap, int oetype){
    double tol = 1e-6;
    double hmax = 5;
    int n_reject = 0;
    int reject = 0;
...
int main(){
    ...
    if(oetype==0) {
        if(body==0){
            FILE_PATH = "/Users/bhanson/Library/CloudStorage/OneDrive-UCSanDiego/UCSD/Research/GBEES/GBEES/R2BP/UKF/cmake-build-debug/Epochs/Earth/Classical";
        }else if(body==1) {
            FILE_PATH = "/Users/bhanson/Library/CloudStorage/OneDrive-UCSanDiego/UCSD/Research/GBEES/GBEES/R2BP/UKF/cmake-build-debug/Epochs/Europa/Classical";
        }
    }
    else if(oetype==1){
        if(body==0){
            FILE_PATH = "/Users/bhanson/Library/CloudStorage/OneDrive-UCSanDiego/UCSD/Research/GBEES/GBEES/R2BP/UKF/cmake-build-debug/Epochs/Earth/Equinoctial";
        }else if(body==1) {
            FILE_PATH = "/Users/bhanson/Library/CloudStorage/OneDrive-UCSanDiego/UCSD/Research/GBEES/GBEES/R2BP/UKF/cmake-build-debug/Epochs/Europa/Equinoctial";
        }
    }
    else if(oetype==2){
        if(body==0){
            FILE_PATH = "/Users/bhanson/Library/CloudStorage/OneDrive-UCSanDiego/UCSD/Research/GBEES/GBEES/R2BP/UKF/cmake-build-debug/Epochs/Earth/Cartesian";
        }else if(body==1) {
            FILE_PATH = "/Users/bhanson/Library/CloudStorage/OneDrive-UCSanDiego/UCSD/Research/GBEES/GBEES/R2BP/UKF/cmake-build-debug/Epochs/Europa/Cartesian";
        }
    }
    //===========================================================================================================
    ...
    for(int i=1; i < tspan.n_elem; i++){
        ...
        for(int j=0; j < 2*DIM+1; j++) {
            A.col(j) = RK87(tspan(i-1), tspan(i),A.col(j), h, lyap, oetype);
        }
