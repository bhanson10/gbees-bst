function dbees                                   % GBEES code base with comments by Ben Hanson    
%%%%%%%%%%%%%%%%% begin user input %%%%%%%%%%%%%%%% 
T=1; G.thresh=0.00002; G.max=10000; start=[-11.5; -10; 9.5]; 
G.dt=.0005; dt=.005; G.dx=0.4; G.d=3; G.sigma=4; G.b=1; G.r=48; G.L=30;

%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% G is an object and all of its parameters are being specified here
% G.thresh = sparsity threshold value 
% G.max = number of cells in each direction, ex: 10,000x10,000x10,000 grid
% G.dt = timestep size
% G.dx = the length, width/height of a single cell
% G.d = number of dimensions 
% G.sigma, G.b, G.r, G.L = Lorentz attractor parameter values that make
%   system chaotic
%
% T = total time, normalized
% start = this is the starting point for the Lorentz attractor function
% dt = time step width
%%%%%%%%%%%%%%% End of Hanson Comments %%%%%%%%%%%%%%

%%%%%%%%%%%%%%%% end of user input %%%%%%%%%%%%%j%% 
G.Y=eye(G.d,'int16'); [D]=Initialize_D(G); h1=round(G.dx/G.dt);

%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% G.Y = identity matrix of size dxd where d is the number of dimensions
% Initialize_D = takes the G object and makes a bunch of lists of
%   zeros/ones of varying sizes, all of size 10000xn where n is either 1 or 
%   d (dimension)
% D.P = [10000×1 double], this is the probability value, all zeros to
%   begin
% D.j = [10000×3 int16], all zeros
% D.k = [10000×3 int16], all ones
% D.v = [10000×3 double], all zeros
% D.i = [10000×3 int16], all ones
% D.w = [10000×3 double], all zeros
% D.u = [10000×3 double], all zeros
% D.f = [10000×3 double], all zeros
% D.m = 1332,
% D.n = 1332,
%
% h1 = dx/dt, 800, 
...
%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% figure(1): creates a new figure and sets its Number property to 1
% clf: clear figure
% y = set to start which was previously set at the beginning
% ys = y, as ys is going to vary
%%%%%%%%%%%%%% End of Hanson Comments %%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% This portion of the code is plotting the Lorentz Attractor as 10,000
%   different data points using the RHS function 
% RHS = right-hand side of the Lorentz Attractor system
% ynew = solved PDE
% ys = array of points that make up the final plot, 3x10,000 array
% view(az, el) = view(az,el) sets the azimuth and elevation angles of the 
%   camera's line of sight for the current axes.
%%%%%%%%%%%%%% End of Hanson Comments %%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% T/dt = 200 timesteps 
% The first plot function plots a black line of 200 data points following the
%   exact process as Figure 1, but just not the entirety of the 10,000
%   steps
% The second plot function plots two data points, the first and the last of the 
%   previous plot
% This is the "true path" that all other paths will be based off of
%%%%%%%%%%%%%% End of Hanson Comments %%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% This portion of code creates 200 deviations from the true path by
%   slightly changing the x,y, and z starting point by a random amount
%   (up to 0.5)
% The first plot function plots the path itself, and the next 6 plot
%   functions plot 6 points along the path, at the 1,41, 81, 121, 161, and
%   201 spots
%%%%%%%%%%%%%% End of Hanson Comments %%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% This portion of the code is where the groups of data points at different
%   times are being combined to form a PDF, and then the PDF is being
%   marched along. This is the most important part of the code
%%%%%%%%%%%%%% End of Hanson Comments %%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%% Hanson Comments %%%%%%%%%%%%%%%%%%
% This portion of code is saving both plots as image files
%%%%%%%%%%%%%% End of Hanson Comments %%%%%%%%%%%%%%%
%}
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
