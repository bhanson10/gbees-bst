...
function [D] = Modify_pointset(D,G) 
    ...
    for l=1:D.m    % Check/Create Neighbors of Big Cells
        if(D.P(D.keys(l))>G.thresh)
            tic;
            og_state = key_conversion(D.keys(l)); key_time = key_time + toc;
    
            %   Faces (6)
            tic;
            new_key = state_conversion([og_state(1) + 1, og_state(2), og_state(3)]); 
            ...
            iskey_time = iskey_time + toc;
            tic;
            new_key = state_conversion([og_state(1), og_state(2) + 1, og_state(3)]);
            state_time = state_time + toc;
            tic;
            if(~isKey(D.P, new_key)), D.P(new_key) = 0; end
            iskey_time = iskey_time + toc;
            ...
            iskey_time = iskey_time + toc;
            tic;
            new_key = state_conversion([og_state(1), og_state(2), og_state(3) + 1]);
            state_time = state_time + toc;
            tic;
            if(~isKey(D.P, new_key)), D.P(new_key) = 0; end        
            iskey_time = iskey_time + toc;
            ...
            %   Edges (12)
            tic;
            new_key = state_conversion([og_state(1) + 1, og_state(2) + 1, og_state(3)]); 
            state_time = state_time + toc;
            tic;
            if(~isKey(D.P, new_key)), D.P(new_key) = 0; end
            iskey_time = iskey_time + toc;
            ...
            iskey_time = iskey_time + toc;
            tic;
            new_key = state_conversion([og_state(1) + 1, og_state(2), og_state(3) + 1]);
            state_time = state_time + toc;
            tic;
            if(~isKey(D.P, new_key)), D.P(new_key) = 0; end
            iskey_time = iskey_time + toc;
            ...
            iskey_time = iskey_time + toc;
            tic;
            new_key = state_conversion([og_state(1), og_state(2) + 1, og_state(3) + 1]); 
            state_time = state_time + toc;
            tic;
            if(~isKey(D.P, new_key)), D.P(new_key) = 0; end
            iskey_time = iskey_time + toc;
            ...
            %   Corners (8)
            tic;
            new_key = state_conversion([og_state(1) + 1, og_state(2) + 1, og_state(3) + 1]); 
            state_time = state_time + toc; 
            tic;
            if(~isKey(D.P, new_key)), D.P(new_key) = 0; end
            iskey_time = iskey_time + toc;
