...
int main(){
    ...
    if (body == 0) {
        FILE_PATH = "/Users/bhanson/Library/CloudStorage/OneDrive-UCSanDiego/UCSD/Research/GBEES/GBEES/PCR3BP/EnKF/cmake-build-debug/Epochs/Europa";
    }
    //===========================================================================================================
    ...
    std::cout << "Program time: " << elapsed.count() << " s, Sim. time: " << 0 << " TU, Members: " << M.size << std::endl;
    ...
    for(int i=1; i < tspan.n_elem; i++){
        ...
        if(OUTPUT){
            ...
            std::cout << "Program time: " << elapsed.count() << " s, Sim. time: " << tspan(i) << " TU, Members: " << M.size << std::endl;
        }
