/*		coding A S Sharma 6-10/2009				*/
/*		based on dbees.m, T Bewley 6/2009		*/
//
//		CHANGELOG
//		v0.1 used vectors; slow
//		v0.2 uses maps; O(log(n)) most ops
//		v0.3 implements key by {i,j,k}
//			and sparserotate neighbour tracking by iterators,
//			uses lists efficiently,
//			Gudenov, flux limiting etc
...
//		v1.0.9 Gaussian reference distribution for m im H calculation;
//				and dump/plot distrib every given time
...
//		Pin down H
//		Parallelisation / OpenMP / MPI? -- may not be parallelisable
...
int main() {
	...
	double const dx=0.5; //Lorenz case, between .1 and 1 is OK - watch EPS!
	//double dt_max=0.001;
	double dt=.0005;
	double T=1;
	//double maxv=1;
	...
	*/
	...
	P.initialise(x0,.5);	//	Gaussian, centred on x0, variance second argument
